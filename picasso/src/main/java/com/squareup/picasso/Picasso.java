...
public class Picasso {
   ...
   * implementations.
   * <ul>
   * <li>LRU memory cache of 1/6th the available application RAM up to 20MB</li>
   * <li>Disk cache of 1% storage space up to 50MB but no less than 5MB. (Note: this is only
